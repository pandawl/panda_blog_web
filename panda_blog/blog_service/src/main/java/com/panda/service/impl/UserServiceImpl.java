...
import com.panda.dao.UserRoleMapper;
import com.panda.manage.UserManager;
import com.panda.pojo.QueryRequest;
import com.panda.pojo.blog.User;
import com.panda.pojo.blog.UserRole;
import com.panda.service.CacheService;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public IPage<User> findUserDetail(User user, QueryRequest request) {
        try {
            ...
            IPage<User> userDetail = this.baseMapper.findUserDetail(page, user);
            return userDetail;
        } catch (Exception e) {
            log.error("查询用户异常", e);
            return null;
    ...
    public static void main(String[] args) {
        String wl = MD5Util.encrypt("wl", "123456");

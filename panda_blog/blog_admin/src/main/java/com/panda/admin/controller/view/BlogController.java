...
public class BlogController {
    ...
    @PostMapping("/list")
    public String getList(SearchvVo search, QueryRequest request) {

        return ResultUtils.generateResultStr(ResultCode.SUCCESS, "查询成功", blogService.selectAll(search, request));
    }
